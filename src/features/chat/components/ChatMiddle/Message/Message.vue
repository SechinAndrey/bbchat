...
import type {
  ...
  IPreviewData,
  IRecording,
} from "@src/core/types/types.ts";
import type { Ref } from "vue";

import linkifyStr from "linkify-string";
import { inject, ref } from "vue";

import { getFullName, getMessageById } from "@src/core/helpers/utils.ts";
...
import MessageContextMenu from "@src/features/chat/components/ChatMiddle/Message/MessageContextMenu.vue";
import Receipt from "@src/features/chat/components/ChatMiddle/Message/Receipt.vue";
