...
import AccountSettings from "@src/features/settings/components/SettingsAccordion/AccountSettings.vue";
import PrivacySettings from "@src/features/settings/components/SettingsAccordion/PrivacySettings.vue";
import AppearanceSettings from "@src/features/settings/components/SettingsAccordion/AppearanceSettings.vue";
import NotificationsSettings from "@src/features/settings/components/SettingsAccordion/NotificationsSettings.vue";
