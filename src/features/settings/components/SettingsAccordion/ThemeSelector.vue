...
<template>
  <div class="theme-selector mb-7">
    <div class="mb-6">
      ...
      <p class="body-3 text-color opacity-70">Выберите цветовую схему для интерфейса</p>
    </div>
    ...
    <div class="theme-options flex gap-3">
      <div 
        ...
        :class="{
          'border-primary bg-primary bg-opacity-10': currentTheme.value === 'indigo',
          'border-neutral-200 hover:border-primary hover:bg-primary hover:bg-opacity-5': currentTheme.value !== 'indigo'
        }"
