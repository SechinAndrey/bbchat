        ...
        <SlideTransition animation="slide-down">
          ...
          >
            <p class="body-2 text-color">
              This is content with slide animation
            </p>
          </div>
        </SlideTransition>
      </div>
    ...
    <section class="mb-10">
      ...
      <div class="p-4 border rounded dark:border-gray-600 min-h-[120px]">
        <ScaleTransition>
          ...
          >
            <p class="body-2 text-color">
              This is content with scale animation
            </p>
          </div>
        </ScaleTransition>
      </div>
    ...
    <section class="mb-10">
      ...
      <div class="p-4 border rounded dark:border-gray-600 min-h-[120px]">
        <CollapseTransition>
          ...
          >
            <p class="body-2 text-color">
              This is content with collapse animation
            </p>
          </div>
        </CollapseTransition>
      </div>
    ...
    <section class="mb-10">
      ...
      <div class="p-4 border rounded dark:border-gray-600 min-h-[120px]">
        <ExpandTransition>
          ...
          >
            <p class="body-2 text-color">
              This is content with expand animation
            </p>
          </div>
        </ExpandTransition>
      </div>
